...
return [
    ...
    'a_need_anki' => 'Non. Vous pouvez créer des cartes et les tester directement dans l\'application avec le mode test intégré, sans rien installer. Anki (ou AnkiDroid) n\'est utile que si vous souhaitez synchroniser vos cartes sur votre téléphone avec le système de sync d\'Anki, ou étendre une collection Anki existante.',
